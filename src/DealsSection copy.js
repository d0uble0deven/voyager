...
--> */}
      <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        {/* <img
          src="/public/images/beams.jpg"
          // src="/img/beams.jpg" public/images/beams.jpg
          alt=""
        ...
        {/* <div class="absolute inset-0 bg-center bg-[/public/images/bouquet.png] [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"></div> */}
        {/* <div class="absolute inset-0 bg-center bg-[/public/images/grid.svg] [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"></div> */}
        {/* <div class="absolute inset-0 bg-center bg-[url(/public/images/grid.svg)] [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"></div> */}
